...
caffe_root = '/nobackup_b/faghri/under_convnet/caffe/'
...
model_path_dict = {'caffenet': caffe_root + 'models/bvlc_reference_caffenet/',
                   }

net_fn_dict = {'caffenet': 'deploy.prototxt',
               }

param_fn_dict = {'caffenet': 'bvlc_reference_caffenet.caffemodel',
                 }

data_mean_dict = {'caffenet':
                  binary_to_nparray('../caffe/imagenet_mean_227.binaryproto'),
                  }


def init_model(model_name):
    model_path = model_path_dict[model_name]
    net_fn = model_path + net_fn_dict[model_name]
    param_fn = model_path + param_fn_dict[model_name]
